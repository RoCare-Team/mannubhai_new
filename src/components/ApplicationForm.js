...
const ApplicationForm = ({ activeTab, service, onClose, db }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.selectedService) newErrors.selectedService = 'Service selection is required';
    if (formData.selectedService && formData.skills.length === 0) {
  ...
  const currentService = servicesData[formData.selectedService];
        ...
        <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
            <div className="space-y-6">
              ...
              {/* Skills Section - Only show when service is selected */}
              {formData.selectedService && currentService && (
