...
// ✅ Fixed slider banners with proper fallback handling
const SLIDER_BANNERS = [
  { src: "/ServiceSlider/Electrician_banner.webp", fallback: "/HomeIcons/default-service.png", alt: "electrican banner", title: "electrican banner" },
  { src: "/ServiceSlider/refridgerator-service-banner.png", fallback: "/HomeIcons/default-service.png", alt: "refridgerator-service-banner", title: "refridgerator-service-banner" },
  { src: "/ServiceSlider/ro-service-banner.png", fallback: "/HomeIcons/default-service.png", alt: "Ro-service-banner", title: "Ro-service-banner" },
  { src: "/ServiceSlider/washingBanner.webp", fallback: "/HomeIcons/default-service.png", alt: "washingBanner", title: "washingBanner" },
];
...
const Appliance = () => {
  ...
  const handleImageError = useCallback((index) => {
    console.warn(`Slider image failed to load: ${SLIDER_BANNERS[index].src}`);
  ...
  return (
    <>
      ...
      <main className="relative min-h-screen bg-gray-50" role="main">
        ...
        <section className="hero-section w-full px-4 sm:px-6 lg:px-8 pb-8 mt-8">
          <div className="max-w-7xl mx-auto">
            <div className="hero-section-container flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
              ...
              <div className="hero-section-service flex-1 w-full order-2 lg:order-1">
                ...
                <header className="text-center lg:text-left mb-6 lg:mb-8 hidden md:block">
                  ...
                  <p className="text-gray-600 mt-3 text-sm sm:text-base lg:text-lg max-w-2xl">
                    Professional appliance repair and maintenance services in the comfort of your home
                  </p>
                </header>

                {/* Sub Services Section */}
                <section aria-labelledby="sub-services-heading" className="services-part mb-6 lg:mb-8">
                  {/* "What are you looking for?" - Hidden on Mobile */}
                  <h2
                    id="sub-services-heading"
                    className="text-lg sm:text-xl font-semibold mb-4 text-center lg:text-left text-gray-800 hidden md:block"
                  >
                    What are you looking for?
                  </h2>
                  
                  {/* ✅ Services Grid - Mobile: 4 per row, Desktop: same as before */}
                  {subServices.length > 0 ? (
                    <div className="grid grid-cols-4 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-4 border border-gray-200 rounded-xl p-2 sm:p-4 bg-white shadow-sm">
                      {subServices.map((service) => (
                        <article
                          key={service.id}
                          className="flex flex-col items-center p-2 sm:p-4 rounded-lg border border-gray-100 bg-gray-50 hover:bg-white hover:shadow-md hover:border-blue-200 transition-all duration-300 cursor-pointer group focus:outline-none focus:ring-2 focus:ring-blue-500"
                          onClick={() => handleSubServiceClick(service)}
                          onKeyDown={(e) => {
                            if (e.key === 'Enter' || e.key === ' ') {
                              e.preventDefault();
                              handleSubServiceClick(service);
                            }
                          }}
                          tabIndex={0}
                          role="button"
                        ...
                        >
                          <div className="relative w-8 h-8 sm:w-16 sm:h-16 lg:w-20 lg:h-20 mb-1 sm:mb-3 transition-transform duration-300 group-hover:scale-110">
                            <Image
                          ...
                          <h3 className="text-[10px] sm:text-sm font-medium text-center text-gray-700 group-hover:text-blue-600 transition-colors duration-300 leading-tight">
                            {service.ServiceName}
                          </h3>
                        </article>
                      ))}
              ...
              {/* ✅ Main Banner with improved error handling - Hidden on Mobile */}
              <div className="hero-section-main-img flex-1 w-full order-1 lg:order-2 relative hidden md:block">
                <div className="relative w-full h-64 sm:h-80 md:h-96 lg:h-[500px] border border-gray-200 rounded-xl overflow-hidden shadow-lg bg-gray-100">
                  <Image
                    src={MAIN_BANNER}
                    alt="Professional home appliance services - technician working on appliances"
                    fill
                    className="object-cover hover:scale-105 transition-transform duration-500"
                    priority
                    sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 600px"
                    onError={(e) => {
                      console.warn("Main banner failed to load:", MAIN_BANNER);
                    }}
                  />
                </div>
              </div>
        ...
        {/* ✅ Fixed Services Swiper Slider - Better Mobile Experience */}
              ...
              >
                {SLIDER_BANNERS.map((banner, idx) => (
                  <SwiperSlide key={`banner-${idx}`}>
                    <div className="rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 group cursor-pointer bg-gray-100 relative">
                      <Image
        ...
        {/* ✅ Promotional Banner with improved error handling */}
        <section className="w-full px-4 sm:px-6 lg:px-8 my-8 sm:my-12" aria-label="Promotional Banner">
          <div className="max-w-7xl mx-auto">
            <div className="relative w-full h-32 sm:h-48 md:h-64 lg:h-80 rounded-xl overflow-hidden shadow-lg bg-gray-100">
              <Image
                src={PROMO_BANNER}
                alt="Special offers on appliance services - promotional banner"
                fill
                className="object-cover"
                sizes="(max-width: 768px) 100vw, (max-width: 1024px) 90vw, 1200px"
                onError={(e) => {
                  console.warn("Promotional banner failed to load:", PROMO_BANNER);
                }}
              />
            </div>
          </div>
        ...
        <section className="mt-8 sm:mt-12 lg:mt-16 w-full" aria-labelledby="appliances-heading">
          <h2 id="appliances-heading" className="sr-only">
            Additional Appliance Services
          </h2>
          ...
          <div className="max-w-7xl mx-auto space-y-8 sm:space-y-12">
            {[
              ...
              },
              {
                ...
                content:
                  "With trained and skilful service engineers, the organization offers highly rated water purifier services. Here you can avail all brands and water purifier services at your house at an affordable price. Furthermore, at Mannu Bhai, you can hire a technician for installation, repair, and routine services.",
                features: [],
              },
              {
                title: "Air Conditioner",
                content:
                  "Get top class and reliable AC services at your doorstep across PAN India. The organization has highly trained professionals for all brand's air conditioner services. Here you can hire a professional for the window to split air conditioner service.",
                features: [],
              },
              {
                title: "Washing Machine",
                content:
                  "Mannu Bhai is a trusted name in offering washing machine service across PAN India. Here the technician is an expert and can fix the washing machine issues of all brands and models. Moreover, our expert will test the appliance after services and only when you are satisfied completely.",
                features: [],
              },
              {
                title: "Refrigerator",
                content:
                  "From gas filling services to regular maintenance and routine service, Mannu Bhai is offering all refrigerator services at your doorstep in PAN India. So to avail mind-blowing and satisfactory at your doorstep in PAN India, contact Mannu Bhai.",
                features: [],
              },
            ].map((section, index) => (
              <article
                ...
                {section.features.length > 0 && (
                  <ul className="space-y-2" role="list">
                    {section.features.map((feature, idx) => (
                      ...
                      >
                        <span
                          className="text-blue-500 font-bold mt-1 flex-shrink-0"
                          aria-hidden="true"
                        >
                          •
                        </span>
