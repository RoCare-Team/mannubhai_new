export default function Head() {
  return (
    <>
      ...
      <meta
        name="description"
        content="Mannu Bhai is one of the most trusted handyman service providers in India. We provide excellent services for painters, plumbers, carpenters, electricians,and masons"/>
