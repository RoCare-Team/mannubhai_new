  ...
  return (
    <section className="py-8 md:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Stats Banner - Added from your image */}
        <div className="bg-indigo-700 text-white rounded-lg p-6 mb-8 md:mb-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div className="p-4">
              ...
              <p className="text-sm md:text-base">Quick Service Delivery Centers</p>
            </div>
            <div className="p-4">
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              {[
                ...
                },
                {
                  ...
                  title: "Head Office",
                  content: "Unit No 831 8th Floor, Head Office, JMD MEGAPOLIS, Sector 48, Gurugram, Haryana 122018"
                }
              ].map((item, index) => (
            ...
            {currentStep === 3 && (
              <div className="space-y-4 md:space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm md:text-base mb-3 md:mb-4">Phone verified: {formData.phone} ✓</p>
                </div>
                ...
                {[
                  ...
                  <div key={field.id}>
                    ...
                    {errors[field.id] && <p className="text-red-500 text-xs md:text-sm mt-1">{errors[field.id]}</p>}
                  </div>
                ))}
